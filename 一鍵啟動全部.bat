...
start "FUYU 後端" cmd /k "cd /d C:\Users\705\Desktop\BigOne\paddle\FUYU\backend && C:\Users\705\anaconda3\envs\paddle_env\python.exe -m uvicorn app.main:app --reload --host 0.0.0.0 --port 8000 || pause"
